...
def run(
    ...
    for index in tqdm(range(iteration), desc=f'iteration'):
        ...
        centers = local_search.fast_local_search(data, centers)
        ...
        result.loc[(dataset, model_name,data_path.name.split('_')[0], k, rounds, batch, minibatch_rounds, index)] = [ari, nmi, db, ch, acc, f1s, rs, ps,loss, total_time]
...
if __name__ == '__main__':
    ...
    result_dir = SETTING.RESULT / dataset_name/'fast_local_search'
